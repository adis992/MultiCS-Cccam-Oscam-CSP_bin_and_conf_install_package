...
NOTE: 
- Mail sending uses the javamail api: http://java.sun.com/products/javamail/downloads/index.html
  The mail.jar file is all thats needed, place it in proxy-home/lib. 
      ...
      <email enabled="true"> <!-- this requires javamail: mail.jar placed in lib -->
        ...
        <auto-email min-interval="600" enabled="true"> <!-- max one mail per 10 mins and user -->
          ...
          <msg-trigger match-events="4 8">
            <msg format="CWS Event: {0}" target="someuser"/> <!-- mail this user when any connector wont connect -->
          </msg-trigger>
        </auto-email>
